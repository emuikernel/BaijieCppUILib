...
namespace agg
{
    ...
    public:
        ...
        line_profile_aa(real w, const GammaF& gamma_function) : 
            m_subpixel_width(0),
            m_min_width(1.0f),
            m_smoother_width(1.0f)
        {
        ...
        //---------------------------------------------------------------------
        void min_width(real w) { m_min_width = w; }
        void smoother_width(real w) { m_smoother_width = w; }
        ...
        { 
            ...
            for(i = 0; i < aa_scale; i++)
            {
                m_gamma[i] = value_type(
                    uround(gamma_function(real(i) / aa_mask) * aa_mask));
            }
        }
        ...
        //---------------------------------------------------------------------
        real min_width() const { return m_min_width; }
        real smoother_width() const { return m_smoother_width; }
    ...
    private:
        ...
        value_type* profile(real w);
        void set(real center_width, real smoother_width);
