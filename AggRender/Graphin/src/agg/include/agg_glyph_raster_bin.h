...
namespace agg
{
    ...
    public:
        ...
        //--------------------------------------------------------------------
        real height()    const { return m_font[0]; }
        real base_line() const { return m_font[1]; }

        //--------------------------------------------------------------------
        template<class CharT>
        real width(const CharT* str) const
        {
        ...
        //--------------------------------------------------------------------
        void prepare(glyph_rect* r, real x, real y, unsigned glyph, bool flip)
        {
            unsigned start_char = m_font[2];
            unsigned num_chars = m_font[3];
