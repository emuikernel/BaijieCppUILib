...
namespace agg
{
    ...
    public:
        ...
        const real* vertices() const { return m_vertices;     }
        real*       vertices()       { return m_vertices;     }
    ...
    public:
        ...
        bezier_arc_svg(real x1, real y1, 
                       real rx, real ry, 
                       real angle,
                       bool large_arc_flag,
                       bool sweep_flag,
        ...
        const real* vertices() const { return m_arc.vertices();     }
        real*       vertices()       { return m_arc.vertices();     }
